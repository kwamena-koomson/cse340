...
SELECT pt.oid, pt.typtype, pt.typname, STRING_AGG(pe.enumlabel, ', ') AS enum_values
FROM pg_enum AS pe
JOIN pg_type AS pt ON pe.enumtypid = pt.oid
WHERE pt.typname = 'account_type'
GROUP BY pt.typname, pt.typtype, pt.oid;